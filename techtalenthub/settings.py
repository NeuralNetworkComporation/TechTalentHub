...
ALLOWED_HOSTS = ['*']  # В продакшене заменить на реальный домен
...
ROOT_URLCONF = 'techtalenthub.urls'
...
WSGI_APPLICATION = 'techtalenthub.wsgi.application'
...
TIME_ZONE = 'Europe/Moscow'  # Наш часовой пояс
USE_I18N = True
USE_TZ = True
